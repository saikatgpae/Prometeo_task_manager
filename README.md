...
> "To-do List" is a simple website that displays a list of works and allows you to add, edit, delete and filter from that list.


## Built With

- Major languages HTML, CSS, JavaScript, TypeScript.
...
git clone git@github.com:saikatgpae/react-todo-app.git
